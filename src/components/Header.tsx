...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-white border justify-between flex flex-row px-4 p-2 items-center">
      <img src={"./starknet-logo.png"} alt="Starknet Logo" className="h-8" />{" "}
      {address ? (
